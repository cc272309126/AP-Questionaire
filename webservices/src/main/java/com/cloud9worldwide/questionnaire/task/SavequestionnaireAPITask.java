 ...
 */
public class SavequestionnaireAPITask extends AsyncTask<String, Integer, String> {
    private Context context;
    private static final String debugTag = "savequestionnaireAPITask";
    private static final String command = "savequestionnaire";

    public SavequestionnaireAPITask(Context context) {
