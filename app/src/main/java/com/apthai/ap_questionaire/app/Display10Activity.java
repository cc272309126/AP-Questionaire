...
public class Display10Activity extends Activity implements View.OnClickListener {
        ...
        for(int i =0, c = 0, r = 0; i < total; i++, c++){
            ...
            if(i == total-1 && (total%column ==2||total%column==3)){
                if(total%column==2){
                    ...
                    lp.weight = 1;
                    lp.setMargins(delegate.pxToDp(20), delegate.pxToDp(10), delegate.dpToPx(20), delegate.pxToDp(10));
                    btn.setLayoutParams(lp);
                    linearLayout.addView(btn);
                } else {
                    btn = new LinearLayout(this);
                    ...
                    lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
                    lp.weight = 1;
                    lp.setMargins(delegate.pxToDp(20), delegate.dpToPx(10), delegate.pxToDp(20), delegate.pxToDp(10));
                    btn.setLayoutParams(lp);
                    linearLayout.addView(btn);
                }
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.display10, menu);
        return true;
    }
